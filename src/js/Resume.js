...
const Resume = () => {
    ...
    <section id="resume" className="animated-section">
        <div className="container">
            ...
            <section id="edu" className="">
                ...
                <Row>
                    <Col className=''>
                    <h4>Colorado State University, Fort Collins, CO</h4>
                    </Col>
                    <Col className='text-end'>
                    <h5>August 2022 - Expected August 2024</h5>
                    </Col>
                </Row>
                <Row>
                ...
                <Row>
                    <Col className=''>
                    <h4>Front Range Community College, Longmont, CO</h4>
                    </Col>
                    <Col className='text-end'>
                    <h5>August 2019 - August 2022</h5>
                    </Col>
                </Row>
                <Row>
                ...
                <Row>
                    <Col className=''>
                    <h4>CompTIA Security+ Certification</h4>
                    </Col>
                    <Col className='text-end'>
                    <h5>Issued December 2023</h5>
                    </Col>
                </Row>
                <Row>
                    <h5>Bachelor of Science, Major in Computer Science, GPA: 3.029</h5>
